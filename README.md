...
| ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------ | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| 2026 | **CoxFormer enables spatial omics inference with multimodal generative modeling** | Nat. Commun. | Emerge   | [link](https://www.nature.com/articles/s41467-026-76404-8) |  [link](https://github.com/yyyancy/CoxFormer)  |
...
| Year | Title                                                                                                                            | Venue                         | Method          | Prediction Target            | Paper                                                                | Code                                                               |
| ---- | -------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- | --------------- | ---------------------------- | -------------------------------------------------------------------- | ------------------------------------------------------------------ |
| 2026 | **Hetairos is a histology-based artificial intelligence model for predicting central nervous system tumor methylation subtypes** | Nature Cancer                 | Hetairos        | **DNA methylation subtypes** | [link](https://www.nature.com/articles/s43018-026-01186-3)           | [link](https://github.com/gerstung-lab/Paion)                      |
| 2026 | **HisToSpatialCNV: an interpretable deep learning method predicting spatial copy number variations from histopathology images**  | Nature Biomedical Engineering | HisToSpatialCNV | **Spatial CNVs**             | [link](https://www.nature.com/articles/s41551-026-01754-z)           | -                                                                  |
| 2026 | **DeepPathway: Predicting Pathway Expression from Histopathology Images**                                                        | Bioinformatics                | DeepPathway     | **Pathway expression**       | [link](https://doi.org/10.1093/bioinformatics/btag643)               | [link](https://github.com/aahsan045/DeepPathway)                   |
| 2026 | **Ultrarapid deep 3D histology enables intraoperative mapping of glioma infiltration**                                           | Cell                          | ULTRA           | **Glioma infiltration**      | [link](https://www.cell.com/cell/fulltext/S0092-8674%2826%2900824-X) | [link](https://github.com/Zhijie-Liu/Ultrarapid-Deep-3D-Histology) |
...
| ---- | --------------------------------------------------------------------------------------------------------------------- | ----------------- | ------- | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------- |
| 2026 | **DPAS-Graph: adaptive spatial-feature relation learning for spatial RNA-to-protein prediction and virtual protein profiling** | Brief. Bioinform. | DPAS-Graph | Spatial RNA → Protein | [link](https://doi.org/10.1093/bib/bbag480) | [link](https://github.com/xmy413/DPAS-Graph) |
...
| 2025 | **SpaIM: single-cell spatial transcriptomics imputation via style transfer** | Nat. Commun. | SpaIM | Spatial RNA → Enhanced RNA | [link](https://doi.org/10.1038/s41467-025-63185-9) | [link](https://github.com/QSong-github/SpaIM) |
| 2024 | **ENGEP: advancing spatial transcriptomics with accurate unmeasured gene expression prediction** | Genome Biol. | ENGEP | Spatial RNA → Enhanced RNA | [link](https://doi.org/10.1186/s13059-024-03398-5) | [link](https://github.com/Zhangxf-ccnu/ENGEP) |
